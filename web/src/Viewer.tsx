      ...
      <div className="v-stage">
        ...
        <div className="v-content">
          ...
          {/* Nothing is a dead end.
              There is no preview for a .ini, a subtitle file with the wrong
              extension, or something whose name lies about what it is — but
              there is always the file itself, and reading it settles what it is
              without leaving the app to find out. */}
          {url && !previewable && (
            <RawView url={url} size={file.size} />
          )}
        </div>
