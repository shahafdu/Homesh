        ...
        new Thread(() -> {
            ...
            main.post(() -> {
                ...
                if (ok) {
                    ...
                    // Back to whatever this app opens with, rather than to a
                    // named class. Two apps are built from these sources — the
                    // television's and the phone's — and naming one of them here
                    // made this screen belong to that one.
                    Intent home = getPackageManager()
                            .getLaunchIntentForPackage(getPackageName());
                    if (home != null) startActivity(home);
                    finish();
                } else {
