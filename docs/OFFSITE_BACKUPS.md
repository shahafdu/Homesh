...
- Backups are taken hourly and kept one a day for a week and one a week for five
  weeks, here and in the bucket -- so there is always a point about two weeks
  back and one about a month back. **Settings → Backups.**
