...
|---|---|---|---|
| **Oracle Cloud Always Free** | arm64 | **Free, permanent** | Whatever the console marks eligible — 1 OCPU / 6 GB in some regions as of September 2026 — plus 200 GB block storage. Recommended starting point |
...
- On **15 June 2026 Oracle silently halved** the Always Free Ampere allowance from 4 OCPU/24 GB
  ...
  2026 some regions' consoles offer 1 OCPU / 6 GB and no larger eligible size. Assume the
